        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <div className="glass-card p-8 lg:p-12 space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">By accessing or using NetGuidePro's website and services, you agree to be bound by these Terms & Conditions. If you do not agree with any part of these terms, you should not use our services.</p>
            </section>
            <section>
              <h2 className="text-xl font-bold font-display mb-3">2. Nature of Services</h2>
              <p className="text-muted-foreground leading-relaxed">NetGuidePro is an independent third-party service assistance provider. We offer general guidance and informational support related to internet, broadband, Wi-Fi, cable TV, and streaming services. We are not an Internet Service Provider (ISP), and we do not sell, resell, or provide internet or cable services directly. We are not affiliated with, authorized by, or endorsed by any telecom, internet, or cable TV provider.</p>
            </section>
            <section>
              <h2 className="text-xl font-bold font-display mb-3">3. Service Fees</h2>
              <p className="text-muted-foreground leading-relaxed">NetGuidePro charges a separate service fee for the independent assistance and guidance provided. This fee is entirely separate from any charges or billing by your internet, cable, or streaming service provider.</p>
            </section>
            <section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">NetGuidePro shall not be held liable for any direct, indirect, incidental, or consequential damages arising from the use of our informational services. Our guidance is provided on an "as-is" basis.</p>
            </section>
            <section>
