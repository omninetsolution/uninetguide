          ...
          <div className="glass-card p-8 lg:p-12 space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Uninetguide is an independent third-party service assistance provider. We are not affiliated with, authorized by, or endorsed by any internet, broadband, cable TV, streaming, or telecom service provider. Brand names, trademarks, and service marks mentioned on this website, if any, are the property of their respective owners and are used strictly for informational purposes only.
              </p>
            </section>
            <section>
              <h2 className="text-xl font-bold font-display mb-3">Nature of Our Services</h2>
              <p className="text-muted-foreground leading-relaxed">
                Uninetguide provides general guidance and informational assistance related to internet, broadband, Wi-Fi, and cable TV services. We do not provide internet or cable services directly. We do not sell, resell, or distribute any service plans, subscriptions, or packages. We do not provide official customer support for any brand. We do not offer guaranteed technical fixes or resolutions.
              </p>
            </section>
            <section>
              <h2 className="text-xl font-bold font-display mb-3">Service Fees</h2>
              <p className="text-muted-foreground leading-relaxed">
                Uninetguide charges a separate service fee for the independent assistance and guidance we provide. This fee is completely independent of any billing or charges from your internet, cable, or streaming service provider.
              </p>
            </section>
            <section>
              <h2 className="text-xl font-bold font-display mb-3">No Impersonation</h2>
              <p className="text-muted-foreground leading-relaxed">
                Uninetguide does not impersonate, represent, or act on behalf of any internet service provider, cable company, telecom operator, or streaming platform. Our call greeting confirms: "Thank you for calling Uninetguide, an independent service assistance platform."
              </p>
            </section>
            <section>
